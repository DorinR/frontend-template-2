...
export const Tabs = () => {
  ...
  return (
    <>
      ...
      <TabsContainer>
        <TabHeader>
          <TabHeaderButton onClick={() => setCurrentlyDisplayedTab("tab1")}>
            Tab 1
          </TabHeaderButton>
          <TabHeaderButton onClick={() => setCurrentlyDisplayedTab("tab2")}>
            Tab 2
          </TabHeaderButton>
          <TabHeaderButton onClick={() => setCurrentlyDisplayedTab("tab3")}>
            Tab 3
          </TabHeaderButton>
        </TabHeader>
